...
public extension UILayoutGuide {
    var Top: JustLayoutYAxisAnchor {
        JustLayoutYAxisAnchor(anchor: topAnchor)
    }

    var Bottom: JustLayoutYAxisAnchor {
        JustLayoutYAxisAnchor(anchor: bottomAnchor)
    }

    var Left: JustLayoutXAxisAnchor {
        JustLayoutXAxisAnchor(anchor: leftAnchor)
    }

    var Right: JustLayoutXAxisAnchor {
        JustLayoutXAxisAnchor(anchor: rightAnchor)
    }

    var Leading: JustLayoutXAxisAnchor {
        JustLayoutXAxisAnchor(anchor: leadingAnchor)
    }

    var Trailing: JustLayoutXAxisAnchor {
        JustLayoutXAxisAnchor(anchor: trailingAnchor)
    }

    var CenterX: JustLayoutXAxisAnchor {
        JustLayoutXAxisAnchor(anchor: centerXAnchor)
    }

    var CenterY: JustLayoutYAxisAnchor {
        JustLayoutYAxisAnchor(anchor: centerYAnchor)
    }
}
...
public func + (left: JustLayoutYAxisAnchor, right: CGFloat) -> JustLayoutYAxisAnchor {
    JustLayoutYAxisAnchor(anchor: left.anchor, constant: right)
}
...
public func + (left: JustLayoutXAxisAnchor, right: CGFloat) -> JustLayoutXAxisAnchor {
    JustLayoutXAxisAnchor(anchor: left.anchor, constant: right)
}

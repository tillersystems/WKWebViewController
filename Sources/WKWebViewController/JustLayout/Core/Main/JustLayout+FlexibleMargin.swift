...
public prefix func >= (p: CGFloat) -> JustLayoutFlexibleMargin {
    JustLayoutFlexibleMargin(points: p, relation: .greaterThanOrEqual)
}

prefix operator <=
@discardableResult
public prefix func <= (p: CGFloat) -> JustLayoutFlexibleMargin {
    JustLayoutFlexibleMargin(points: p, relation: .lessThanOrEqual)
}
...
public func - (left: UIView,
    ...
    PartialFlexibleConstraint(fm: right, view1: left, views: nil)
}

@discardableResult
public func - (left: [UIView],
               right: JustLayoutFlexibleMargin) -> PartialFlexibleConstraint {
    PartialFlexibleConstraint(fm: right, view1: nil, views: left)
}
...
public prefix func |- (fm: JustLayoutFlexibleMargin) -> JustLayoutLeftFlexibleMargin {
    JustLayoutLeftFlexibleMargin(fm: fm)
}
...
public postfix func -| (fm: JustLayoutFlexibleMargin) -> JustLayoutRightFlexibleMargin {
    JustLayoutRightFlexibleMargin(fm: fm)
}
